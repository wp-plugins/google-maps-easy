...
<div class="container">
	<form id="gmpWelcomePageNewFindUsForm" method="GET">
		...
		<div class="plug-icon-shell">
			<a target="_blank" href="http://supsystic.com/"><img src="<?php echo $this->getModule()->getModPath(). 'img/plug-icon.png'?>" /></a><br />
			<a target="_blank" href="http://supsystic.com/"><?php echo GMP_WP_PLUGIN_NAME?></a><br />
			<a target="_blank" href="http://supsystic.com/"><?php echo GMP_VERSION?></a><br />
		</div>
		<div class="clear"></div>
		...
		<div class="col-3">
			<h3>Boost us:</h3>
			<p>It's amazing when you boost development with your feedback and ratings. So we create special <a target="_blank" href="http://supsystic.com/">boost page</a> to help you to help us.</p>
		</div>

		<div class="col-3">
			<h3>Documentation:</h3>
			<p>Check <a target="_blank" href="http://supsystic.com/">documentation</a> and FAQ section. If you can't solve your problems - <a target="_blank" href="http://supsystic.com/">contact us</a>.</p>
		</div>
		...
		<div class="col-3">
			...
			<p>So check full features list <a target="_blank" href="http://supsystic.com/">here</a>.</p>
		</div>
		<div class="clear"></div>
		<?php echo htmlGmp::hidden('pl', array('value' => GMP_CODE))?>
		<?php echo htmlGmp::hidden('mod', array('value' => 'promo'))?>
