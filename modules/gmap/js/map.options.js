...
var gmapPreview = {
    ...
    ,	drawMap: function(mapForPreview) {
        ...
        console.log(mapForPreview);
        var mapElemId = 'google_map_easy_'+ mapForPreview.id
        ...
        if(typeof(mapForPreview.params.map_center) != 'undefined') {
            lat = mapForPreview.params.map_center.coord_x;
            lng = mapForPreview.params.map_center.coord_y;
        } else if(mapForPreview.markers && mapForPreview.markers.length > 0) {
            lat = mapForPreview.markers[0].coord_x;
            lng = mapForPreview.markers[0].coord_y;
        }
        ...
        var mapOptions = {
            ...
            //,	scrollwheel: true	//mouse disable
...
//        }
    ...
    ,	createMarker: function(markerItem, mapId) {
        ...
        var markerLatLng = new google.maps.LatLng(markerItem.coord_x, markerItem.coord_y);
